 ...
 * The user can choose to draw spirals or scribbles, and can also choose different color modes.
...
public class SpiralsAndScribbles extends MouseAdapter implements Runnable, ActionListener {
    ...
    /**
     * This method is called when the mouse is dragged. It creates a new ColorLineSegment 
    ...
    /**
     * This method is called when an action event occurs, such as a button press or menu selection.
 ...
 * The line segment is defined by two points, and the color is used when drawing the line.
 */
class ColorLineSegment {
     ...
     * @param p an array of two points representing the endpoints of the line segment
     */
...
class ShapesOfScenes {
    ...
    /**
     * Determines if the given point is near any of the line segments in the collection.
     * 
